...
class _PostavkeDuljinaState extends State<PostavkeDuljina> {
  ...
  onSwitchMethodRjesenje(bool newValue) {
    setState(() {
      if (newValue == true) {
        appState.rjesenjeShownDuljina = true;
      } else {
        appState.rjesenjeShownDuljina = false;
      }
    });
  }
    ...
    return Padding(
      ...
      child: ListView(
        children: [
          ...
          buildSwitchOption('Postupak', appState.postupakShownDuljina,
          ...
          buildSwitchOption('Rješenje', appState.rjesenjeShownDuljina,
          ...
          Padding(
            ...
            child: Text(
              'Težina zadatka: ${appState.currentSliderValueDuljina.round()}',
              style: TextStyle(
          ...
          Padding(
            ...
            child: SliderTheme(
              ...
              child: Slider(
                min: 1,
                max: 4,
                value: appState.currentSliderValueDuljina,
                divisions: 3,
                label: '${appState.currentSliderValueDuljina.round()}',
                onChanged: (value) {
                  setState(() {
                    appState.currentSliderValueDuljina = value;
                  });
                },
              ),
            ),
