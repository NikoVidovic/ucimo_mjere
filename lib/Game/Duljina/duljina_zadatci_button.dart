...
class _ZadatciButtonDuljinaState extends State<ZadatciButtonDuljina> {
  ...
  void fillTheList(valueFrom, valueTo, numberString) {
    appState.taskDuljina = true;
    appState.addItemDuljina(int.parse(numberString));
    appState.addItemDuljina(valueFrom);
    appState.addItemDuljina(valueTo);
                        ...
                        setState(() {
                          if (_selectedValue1 == null &&
                            ...
                            showTemporaryDialog(context,
                                'Odaberite različite mjerne jedinice!');
                            ...
                            showTemporaryDialog(
                                context, 'Zadatak uspješno dodan!');
                          }
                        });
                      },
