...
class ZadatciButtonInformacije extends StatefulWidget {
  const ZadatciButtonInformacije({super.key});

  @override
  State<ZadatciButtonInformacije> createState() =>
      _ZadatciButtonInformacijeState();
}

class _ZadatciButtonInformacijeState extends State<ZadatciButtonInformacije> {
  ...
  void fillTheList(valueFrom, valueTo, numberString) {
    appState.taskInformacije = true;
    appState.addItemInformacije(int.parse(numberString));
    appState.addItemInformacije(valueFrom);
    appState.addItemInformacije(valueTo);
                ...
                Flexible(
                  child: DropdownMenu(
                      ...
                      dropdownMenuEntries: [
                        ...
                        DropdownMenuEntry(
                            value: 1,
                            label: appState.decimalni == true ? 'KB' : 'KiB',
                            style: ButtonStyle(
                                foregroundColor: MaterialStatePropertyAll(
                                    appState.fontColor))),
                        DropdownMenuEntry(
                            value: 2,
                            label: appState.decimalni == true ? 'MB' : 'MiB',
                            style: ButtonStyle(
                                foregroundColor: MaterialStatePropertyAll(
                                    appState.fontColor))),
                        DropdownMenuEntry(
                            value: 3,
                            label: appState.decimalni == true ? 'GB' : 'GiB',
                            style: ButtonStyle(
                                foregroundColor: MaterialStatePropertyAll(
                                    appState.fontColor))),
                        DropdownMenuEntry(
                            value: 4,
                            label: appState.decimalni == true ? 'TB' : 'TiB',
                            style: ButtonStyle(
                                foregroundColor: MaterialStatePropertyAll(
                                    appState.fontColor))),
                      ]),
